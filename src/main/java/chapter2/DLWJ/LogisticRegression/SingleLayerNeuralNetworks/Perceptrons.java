package chapter2.DLWJ.LogisticRegression.SingleLayerNeuralNetworks;

import static chapter2.DLWJ.LogisticRegression.util.ActivationFunction.step;

import java.util.Random;

import chapter2.DLWJ.LogisticRegression.util.GaussianDistribution;
