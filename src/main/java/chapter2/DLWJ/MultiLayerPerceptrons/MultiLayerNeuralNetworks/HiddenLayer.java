package chapter2.DLWJ.MultiLayerPerceptrons.MultiLayerNeuralNetworks;

import java.util.Random;
import java.util.function.DoubleFunction;
import static chapter2.DLWJ.MultiLayerPerceptrons.util.ActivationFunction.*;
import static chapter2.DLWJ.MultiLayerPerceptrons.util.RandomGenerator.uniform;
